        ...
        <Wrapper style={{ backgroundImage: `${linearGradient}, ${background}` }}>
            <Container>
                ...
                <form action="post">
                    ...
                    <input type="email" name="email" onChange={(e) => handleCredentials(e)} required />
                    <label>Enter your password</label>
                    <input type="password" name="pass" onChange={(e) => handleCredentials(e)} required />
                    <button className="submit" onClick={(e) => handleLogin(e)}>Continue</button>
                    {
                        error &&
                        <div className='error'>
                            {error}
                    ...
                    <p id="forgot-password" onClick={handlePasswordReset}>Forgot password?</p>
                </form>
                <h1>Or</h1>
