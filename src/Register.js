        ...
        <Wrapper style={{ backgroundImage: `${linearGradient}, ${background}` }}>
            ...
            <Container>
                ...
                <form>
                    ...
                    <input type="email" className='input' name="email" onChange={(e) => handleCredentials(e)} required />
                    <label>Password</label>
                    <input type='password' name="password" className='input' onChange={(e) => handleCredentials(e)} required />
                    <label>Confirm password</label>
                    <input type='password' name="confirm" className='input' required />
                    <button className='submit' onClick={(e) => handleSignup(e)}>Continue</button>
                    {
                        error &&
                        <div className='error'>
                            {error}
